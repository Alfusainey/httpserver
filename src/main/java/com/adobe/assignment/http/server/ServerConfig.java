...
/**
 * This class bundles the information required to bootstrap
 * the web-server.
 * 
 * @author Alfusainey Jallow, University of Gambia
 */
...
public class ServerConfig {
	...
	/**
	 * The configured web server port. If the port number configuration is missing,
	 * a default port of zero is selected.
	 */
	 ...
	 * 
	 * @return 		The host the server is running on. Localhost
	 * 				is returned in the event of a missing host
	 * 				configuration.
	 */
	...
	public void parse(InputStream is) throws SAXException {
	 ...
	 private static HttpMethodHandler buildClassFromConfig(Element parent) {
		// copied from org.apache.jackrabbit.webdav.simple.ResourceConfig and modified
		// for our purpose.
